 ...
 *
 */
public class HelloSimpleDB implements Credentials {
	...
	// Dentro do ReplaceableItem, você pode inserir vários atributos organizados
	// por chave e valor para organizar suas informações.
	private static List<ReplaceableItem> createSampleData() {
		List<ReplaceableItem> dados = new ArrayList<ReplaceableItem>();
		dados.add(new ReplaceableItem("Usuario_01").withAttributes(new ReplaceableAttribute("nome", "Ricardo", true),
		...
		dados.add(new ReplaceableItem("Usuario_02").withAttributes(new ReplaceableAttribute("nome", "Teste", true),
				new ReplaceableAttribute("sobrenome", "Testado", true),
				new ReplaceableAttribute("empresa", "Livetouch", true),
				new ReplaceableAttribute("site", "http://livetouch.com.br", true),
				new ReplaceableAttribute("email", "teste@gmail.com", true)));
		dados.add(new ReplaceableItem("Usuario_03").withAttributes(new ReplaceableAttribute("nome", "Mickey", true),
